...
LOGIN_URL = "/"  # ログインするページ。デフォルトにするなら"/admin/login/"等も
LOGIN_REDIRECT_URL ='sales:after_login' # ログインページに直接飛んだとき、ログイン完了後のリダイレクト先
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'fruit_sales/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
            ...
            # 'libraries':{
            #     'filter': 'portraits.templatetags.filter',
            #     }
        },
    },
]
